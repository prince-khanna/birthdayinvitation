...
- Keep the game page's outer gutters plain like the invitation; botanical artwork belongs inside the paper/hero and must not repeat in the narrow side margins.
- Guest-facing challenge pages must not reveal host preparation or secret prompt contents. Refer teams to Anvika's parents for animal, singing-style, charade-word, and tray materials; keep the actual choices off the page. Team 10 is the family-led Slow-Motion Birthday Party and must not require Anvika to give instructions.
